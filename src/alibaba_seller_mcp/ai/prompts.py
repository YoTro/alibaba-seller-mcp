...
PRODUCT_DETAIL_SYSTEM = (
    ...
    "attribute names and values may use ONLY English letters, digits, spaces and the "
    "punctuation . , / ( ) - : % — no other symbols (e.g. + ° ² ㎡ or non-English "
    "text), so write '365nm/395nm' not '365nm+395nm' and 'sq m' not '㎡'; "
